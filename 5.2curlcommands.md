...
The source can be found at https://github.com/JR-1991/hdf5-previewer
...
'{
  ...
  "scope":"file",
  "types":["preview"],
  "toolUrl":"https://gdcc.github.io/dataverse-previewers/previewers/react-previewers/hdf5-previewer/HDF5Preview.html",
  "toolParameters": {
      "queryParameters":[
        {"fileid":"{fileId}"},
        {"siteUrl":"{siteUrl}"},
